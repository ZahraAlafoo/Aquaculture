...
var phone = "97338805044";
var email = "zahraa_alafoo@hotmail.com";
var given_name = "zahra";
var family_name = "alafoo";
  ...
  methods: {
    ...
    async submitForm() {
      ...
      Auth.updateUserAttributes(user, {
        given_name: this.formValues.given_name,
        family_name: this.formValues.family_name,
        phone_number: this.formValues.phone_number,
      });
      const data = {
        body: {
          email: this.formValues.email,
          contact: this.formValues.phone_number,
        },
      };
      const apiData = await API.post("numbersapi", "/number", data);
      console.log({ apiData });
